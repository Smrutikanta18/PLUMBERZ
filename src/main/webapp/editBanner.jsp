                                ...
                                <div class="card shadow-lg">
                                    ...
                                    <div class="card-body">
                                        <form id="editbannerimage" method="post" enctype="multipart/form-data">
                                            <input type="hidden" name="imageId" value="<%= request.getAttribute("id") %>">

                                            <div class="mb-3">
                                                <label for="image" class="form-label">Upload Image</label>
                                                <input type="file" class="form-control" id="image" name="image" value="<%= request.getAttribute("image") %>"  required>
                                            </div>

                                            <div class="mb-3">
                                                <label for="description" class="form-label">Title</label>
                                                <input type="text" style="background: transparent;" class="form-control" id="description" name="title" value="<%= request.getAttribute("title") %>">
                                            </div>
                                            <div class="mb-3">
                                                <label for="description" class="form-label">Description</label>
                                                <textarea style="background: transparent;" type="text" class="form-control" id="description" name="desc" value="<%= request.getAttribute("description") %>"></textarea>
                                            </div>
                                            <div id="statusMessagePhone" class="mt-2" style="font-size: 10px;"></div>
                                            <!-- Add Button -->
                                            <div class="d-grid">
                                                <button type="button" style="background-color: red; width:20%; margin-left: 220px;" onclick="updateBanner()" class="btn btn-success">Add Image</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
