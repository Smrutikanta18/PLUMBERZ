  ...
  <div class="container-forms">
    ...
    <div class="container-form">
      <div class="form-item log-in">
        ...
        %>
            <div style="color: red; margin-bottom: 20px; margin-left: 50px;"><%= errorMessage %></div>
        <%
            }
        %>
      ...
      <div class="form-item sign-up">
        <div class="table">
          <div class="table-cell">
            ...
            %>
            <div style="color: red; margin-bottom: 20px; margin-left: 50px;"><%= errorMessage1 %></div>
            <%
            }
             %>
          <form action="signup" method="post">
            <input name="email" placeholder="Email" type="text" /><input name="Username" placeholder="Username" type="text" /><input name="password" placeholder="Password" type="Password" /><input name="phone" placeholder="Phone no" type="text" />
